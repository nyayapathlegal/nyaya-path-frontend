...
const ExtraServicesCMS = () => {
    ...
    return (
        <>
            {/* Left content */}
            <CMSSection title="Services Section Content">
            ...
            <div className="mt-4 transition-opacity duration-300 ease-in-out opacity-100">
                <div className="flex flex-col gap-y-4">
                    ...
                    <CMSSubmitButton
                        ...
                        loading={saving}
                        label="Save Extra Services"
                        loadingLabel="Saving Extra Services..."
                    />
                </div>
            </div>
        </>
...
export default ExtraServicesCMS;