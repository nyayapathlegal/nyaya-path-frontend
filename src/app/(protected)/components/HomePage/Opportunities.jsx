...
import { getOpportunities } from  "../../../../api/home/home.api";
import { setOpportunities } from "../../../../api/client/client.api";
...
const Opportunities = () => {
    ...
    const saveFeatures = async () => {
        ...
        try {
            setSaving(true);
            await setOpportunities(data);
            toast.success("Opportunities saved successfully");
        } 
        catch (err) {
            console.error("Failed to save Opportunities", err);
    ...
    if (!data) {
        return <CMSFallback message="No opportunities found." />;
    }

    return (
        <div className="flex flex-col gap-y-4">
            <CMSSection title="Opportunities Section">
                {/* Left Content */}
                <CMSCard>
            ...
            <CMSSubmitButton
                ...
                loadingLabel="Saving Opportunities..."
            />
        </div>
    );
};
