...
import { getClientExperience } from "../../../../api/home/home.api";
import { setClientExperience } from "../../../../api/client/client.api";
...
const Experience = () => {
    ...
    useEffect(() => {
        const fetchFeatures = async () => {
            try {
                ...
                console.error("Failed to fetch legal features", err);
                setData(null);
            }
            finally {
                setLoading(false);
    ...
    const saveFeatures = async () => {
        ...
        try {
            setSaving(true);
            await setClientExperience(data);
    ...
    if (!data) {
        return <CMSFallback message="No experience found." />;
    }

    return (
        <div className="flex flex-col gap-y-4">
            <CMSSection title="Experience Section">
                {/* Left Content */}
                <CMSCard>
